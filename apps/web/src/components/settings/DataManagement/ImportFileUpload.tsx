...
export const ImportFileUpload = ({
  ...
  return (
    <>
      <Typography>Import Abstract Safe Wallet data by uploading a file in the area below.</Typography>
      ...
      <Typography>
        ...
        />
        Only JSON files exported from the Abstract Safe Wallet can be imported.
      </Typography>
    </>
  )
}
