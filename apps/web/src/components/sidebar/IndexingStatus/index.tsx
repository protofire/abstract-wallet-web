...
const STATUS_PAGE = IS_PRODUCTION
  ? 'https://tx-status-app.safe.protofire.io/?serviceUrl=https://gateway.safe.abs.xyz/'
  : 'https://tx-status-app.safe.protofire.io/?serviceUrl=https://gateway.staging.safe.abs.xyz'
