...
const SafePrivacyPolicy = () => (
  <SmoothScroll>
    ...
    <ol>
      ...
      <li>
        &ldquo;Abstract Safe Wallet&rdquo; refers to a web-based graphical user interface for Safe Accounts as well as a
    ...
    <h4>4.1. When visiting our website and using Abstract Safe Wallet</h4>
    <p>
      When visiting our website or using Abstract Safe Wallet, we may collect and process personal data. The data will
    ...
    <ol start={4}>
      <li>
        ...
        the Abstract Safe Wallet, we process your
        <ol>
    ...
    <ol start={8}>
      <li>
        When we collect relevant&nbsp;data&nbsp;from the Blockchain to display context information in the Abstract Safe
        Wallet we process:
        <ol>
          <li>your public Wallet address, </li>
          <li>account balance,</li>
    ...
    <p>
      4.2.2 For general operational analysis of the Abstract Safe Wallet interface, monitoring transaction origins and
    ...
    <p>
      In addition, we may take a recording of you while testing Abstract Safe Wallet for internal and external use. The
    ...
    <p>
      Abstract Safe Wallet mobile apps are distributed via{' '}
    ...
    <p>
      We enable the user to unlock the Abstract Safe Wallet mobile app via biometrics information (touch ID or face ID).
    ...
    <p>
      ...
      different decentralized applications and our app and to enhance your experience with Abstract Safe Wallet. For
...
const PrivacyPolicy: NextPage = () => {
  return (
    <>
      <Head>
        <title>Abstract Safe Wallet – Privacy policy</title>
      </Head>
